module Fog
  module Compute
    class HuaweiCloud < Fog::Service
      ...
      ## MODELS
      #
      model_path 'fog/compute/huaweicloud/models'
      model       :aggregate
      ...
      ## REQUESTS
      #
      request_path 'fog/compute/huaweicloud/requests'
      ...
      class Real
        ...
        def initialize(options = {})
          ...
          @microversion_key = 'X-HuaweiCloud-Nova-API-Version'

          initialize_identity options

          @huaweicloud_identity_service_type = options[:huaweicloud_identity_service_type] || 'identity'

          @huaweicloud_service_type   = options[:huaweicloud_service_type] || %w(nova compute)
          ...
          unless @path =~ %r{/(v2|v2\.0|v2\.1)}
            raise Fog::HuaweiCloud::Errors::ServiceUnavailable,
                  "HuaweiCloud compute binding only supports version v2 and v2.1"
          end
